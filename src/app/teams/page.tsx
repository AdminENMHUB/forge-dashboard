...
const TEAM_PRESETS = [
  {
    name: "self_healing",
    description: "10 zero-LLM-cost agents: SaaS SRE, infra, trading, costs, logs",
    cadence: "Every 15 min + hourly",
    agents: 10,
    color: "emerald",
  },
  {
    name: "operations",
    description: "Alert triage, auto-remediation, signal audit, asset reconciliation",
    cadence: "Every hour",
    agents: 7,
    color: "rose",
  },
  {
    ...
    description: "CFO, Sharpe allocator, strategist — cross-swarm capital decisions",
    cadence: "Daily",
    agents: 6,
    color: "cyan",
  },
  {
    name: "growth",
    description: "CRO, marketing director, content publishing, conversion funnels",
    cadence: "Every hour",
    agents: 6,
    color: "violet",
  },
  {
    name: "daily_strategy",
    description: "Retrospective, hyper-agent, code patches, revenue acceleration",
    cadence: "Daily",
    agents: 7,
    color: "sky",
  },
